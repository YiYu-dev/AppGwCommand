...
$agwhelthprobewa = "$ResourceDefaultNm-$Id-wa-health"
$agwhelthprobefa = "$ResourceDefaultNm-$Id-fa-health"
$agwListner = "$ResourceDefaultNm-Listner"
$agwRouteRule = "$ResourceDefaultNm-RouteRule"
...
| ConvertFrom-Json)
$appGw = Get-ApplicationGateway -Name $agwNm -RgCommonNm
...
--name "$ResouceDefaultNm-rt-to-$Id-wa01" `
...
--name "$ResouceDefaultNm-rt-to-$Id-fa01" `
--next-hop-ip-address 192.168.100.4 `
--next-hop-type VirtualAppliance `
--resource-group $RgCommonNm `
--route-table-name $RtSpoke2hub
